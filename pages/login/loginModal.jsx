...
const LoginModal = () => {
    const {login, setUserData} = useContext(UserData);
    ...
    const handleSubmit = () => {
        setUserData({...data,  logged_in: true });
        setShowModal(false);
    }
    ...
    return (
        <>
            ...
            <button
                ...
                <span className="relative py-1 px-2 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">Login</span>
            </button>

            {
                showModal ?

                    <div className="fixed z-50 w-full p-4 inset-0">
                        {/* BACKGROUND */}
                        ...
                        <div className="relative h-auto">
                            ...
                            <div className="absolute right-0 w-full max-w-md bg-white rounded-lg shadow dark:bg-gray-700">
                                <button
                                ...
                                <div className="px-6 py-6 lg:px-8">
                                    <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Sign in to Todoloo</h3>
